<%-- 
    Document   : Ventas
    Created on : 5 sept. 2021, 18:04:31
                        ...
                        <form method="post" action="/ManejadorVentas?menu=Ventas">
                            <div class="row">
                                ...
                                <div class="col-md-7 d-flex">
                                    ...
                                    <input type="text" name="municipio" class="form-control" placeholder="Municipio" value="${cliente.getMunicipio()}">
                                </div>
                                <br>
                                <div class="col-md-7 d-flex">
                                    <label>Departamento:</label>
                                    <input type="text" name="departamento" class="form-control" placeholder="Departamento" value="${cliente.getDepartamento()}">
                                </div>
